    ...
    <footer className="bg-primary border-t border-accent/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              O'zbekistonning mashhur marmar va granit konlariga investitsiya qilish imkoniyati.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-accent font-semibold mb-4">Ijtimoiy tarmoqlar</h4>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-accent hover:text-dark transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.413c0-3.008 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.613 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="#" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-accent hover:text-dark transition-colors">
        ...
        <div className="border-t border-accent/10 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; 2026 G'ozg'on Investitsion Portali. Barcha huquqlar himoyalangan. | Dastur Mulalifi: Nurmurodov Damir</p>
        </div>
      </div>
    </footer>
  );
